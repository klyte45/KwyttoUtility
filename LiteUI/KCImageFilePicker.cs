...
namespace Kwytto.LiteUI
{
    public class KCImageFilePicker : GUIRootWindowBase
    {
        ...
        public static void PickAFile(string title, Action<string> onReturn)
        {
            ...
            window.Init(title ?? BasicIUserMod.Instance.GeneralName, new Rect(new Vector2((Screen.width / 2) - 400, (Screen.height / 2) - 250) / UIScaler.UIScale, new Vector2(800, 500) / UIScaler.UIScale), true, true, new Vector2(500, 500));
